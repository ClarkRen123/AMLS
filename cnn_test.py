...
#load model
model_path = "./model_taskB.pth"  #change this to "./model_taskA.pth" if testing for task A
...
def imageProcess(img):
    ...
    imgs = imgs.convert('L')  # from 3-channel to 1-channel
    imgsb = img.resize((128, 128))
    imgs = torchvision.transforms.ToTensor(imgsb)
